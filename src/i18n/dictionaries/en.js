const en = {
  ...
  ai: {
    ...
    hudCore: 'AGENT · CORE',
    hudCoreMeta: 'reasoning loop',
    hudStatus: 'THINKING',
    hudMemory: 'MEMORY',
    hudMemoryMeta: 'context · history',
    hudTools: 'TOOLS',
    hudToolsMeta: 'APIs · functions',
    hudContext: 'CONTEXT',
    hudContextMeta: 'rules · policies',
    hudHuman: 'HUMAN · IN · THE · LOOP',
    hudHumanMeta: 'approval gate',
    hudConfidence: 'confidence',
    hudTrace: 'trace',
    hudTraceId: '9c2f-ed81-bbf2',
    hudAudited: 'AUDITED',
    transcript: [
      { tag: 'PLAN', text: 'classify document → extract → score' },
      { tag: 'TOOL', text: 'docs.fetch(id=4291)' },
      { tag: 'OBS',  text: 'amount = $74,200 · vendor = Acme Co.' },
      { tag: 'RULE', text: 'if amount > 50k → human review' },
      { tag: 'GATE', text: 'route → human · awaiting approval' },
      { tag: 'OK',   text: 'approved · ticket #4291 created' },
    ],
  },
  trust: {
