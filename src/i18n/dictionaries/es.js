const es = {
  ...
  ai: {
    ...
    hudCore: 'AGENTE · CORE',
    hudCoreMeta: 'loop de razonamiento',
    hudStatus: 'PENSANDO',
    hudMemory: 'MEMORIA',
    hudMemoryMeta: 'contexto · historial',
    hudTools: 'HERRAMIENTAS',
    hudToolsMeta: 'APIs · funciones',
    hudContext: 'CONTEXTO',
    hudContextMeta: 'reglas · políticas',
    hudHuman: 'HUMANO · EN · EL · LOOP',
    hudHumanMeta: 'puerta de aprobación',
    hudConfidence: 'confianza',
    hudTrace: 'trace',
    hudTraceId: '9c2f-ed81-bbf2',
    hudAudited: 'AUDITADO',
    transcript: [
      { tag: 'PLAN', text: 'clasificar doc → extraer → evaluar' },
      { tag: 'TOOL', text: 'docs.fetch(id=4291)' },
      { tag: 'OBS',  text: 'monto = $74,200 · proveedor = Acme Co.' },
      { tag: 'RULE', text: 'si monto > 50k → revisión humana' },
      { tag: 'GATE', text: 'route → humano · esperando aprobación' },
      { tag: 'OK',   text: 'aprobado · ticket #4291 creado' },
    ],
  },
  trust: {
